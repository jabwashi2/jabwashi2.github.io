    ...
    return (
        <>
            <motion.div whileHover={{ scale: 1.1, transition: { duration: 0.2 }}} transition={{ duration: 0.3 }} class="project-thumbnail" id={props.title}>
                <Link to={ props.category === "web" ? "/Web-Projects/" + props.id : props.category === "uiux" ? "/UIUX-Projects/" + props.id : props.category === "dx11" ? "/DirectX11-Projects/" + props.id : props.category === "game" ? "/Game-Projects/" + props.id : "/Side-Quests/" + props.id}>
